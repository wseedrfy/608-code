...
function runCode(that, e) {
  ...
  that.onShow = () => {
    that.setData({
      ...
      <map id="navi_map" longitude="${that.data.userLongitude}" latitude="${that.data.userLatitude}" scale="18" markers="${JSON.stringify(that.data.markers)}" polyline="${that.data.polyline}" bindmarkertap="makertap" style='width:100%' show-location subkey="JLHBZ-JQELU-I7HVD-B2XSN-5VU3Z-BZFDK" enable-3D="true"
        show-compass>
      ...
      ">
          <cover-view bindtap="jtt">
            <cover-image style="  margin-top: 5px;
            width: 80rpx;
            height: 80rpx;" src="image/staticMap.png" />
          </cover-view>
          <cover-view bindtap="moveSchool">
            <cover-image style="  margin-top: 5px;
            width: 80rpx;
            height: 80rpx;" src="image/moveSchool.png" />
          </cover-view>
          <cover-view bindtap="location">
            <cover-image style="  margin-top: 5px;
            width: 80rpx;
            height: 80rpx;" src="image/location.png" />
          </cover-view>
        </cover-view>
      </map>
    </view>
      ...
      left: 0px;
      right: 0px;" >
        <view style="margin: 15px;">广东石油化工学院 (邮编：525000)</view>
        <view style="margin: 15px;">官渡校区：广东省茂名市茂南区官渡二路139号</view>
        <view style="margin: 15px;">西城校区：茂名市茂南区中科云粤西产业园</view>
      </view>
    </view>`
    }
