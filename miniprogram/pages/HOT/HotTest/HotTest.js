...
function runCode() {
  ...
  return Page({
    ...
    setdata: function setdata(dictData) {
      ...
      var html = "<view  class='containers' style='background-size: 100% 100%; height: 100%; position: fixed; width: 100%; z-index: -1;'>  <image  class='bgc' src='cloud://cloud1-6gtqj1v4873bad50.636c-cloud1-6gtqj1v4873bad50-1307814679/bgc.png' style='height: 100%; width: 100%;'>   </image>  </view> <view  class='title'>  " + ((_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) <= 7 ? "<view  class='model' animation='" + (_typeof(this.data.animationData) === "object" ? JSON.stringify(this.data.animationData) : this.data.animationData) + "' style='background-color: white; border-radius: 50rpx; height: 700rpx; margin: 0rpx auto; position: relative; top: 30vh; width: 72%; z-index: 99;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  class='model-top' style='align-items: center; background-color: rgba(234,129,113); border-radius: 50rpx 50rpx 0rpx 0rpx; color: white; display: flex; font-size: 32rpx; justify-content: center; padding: 30rpx 0rpx;;" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].question) === "object" ? JSON.stringify(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].question) : this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].question) + "  </view> <view  class='model-body ' style='display: flex; height: 47%; justify-content: center; margin-left: 20rpx; margin-right: 20rpx; margin-top: 22%;;model-body " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) != 0 ? 'model-body-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  class='model-body-choose-1 ' bindtap='choose_ans' id='1' style='align-items: center; background-color: #b9cfeb; border-radius: 40rpx; box-sizing: border-box; color: white; display: flex; font-size: 40rpx; height: 100%; justify-content: center; margin: 0rpx 20rpx; padding: 10rpx; transition: all .5s; white-space: normal; width: 45%; word-wrap: break-word;;model-body-choose-1 " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) == 1 ? 'model-body-choose-1-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <text  class='model-body-choose-text ' style='text-align: center; transition: all .5s; width: 100%;;model-body-choose-text " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) == 1 ? 'model-body-choose-text-1-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[0]) === "object" ? JSON.stringify(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[0]) : this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[0]) + "  </text>  </view> <view  class='model-body-choose-2 ' bindtap='choose_ans' id='2' style='align-items: center; background-color: #b9cfeb; border-radius: 40rpx; box-sizing: border-box; color: white; display: flex; font-size: 40rpx; height: 100%; justify-content: center; margin: 0rpx 20rpx; padding: 10rpx; transition: all .5s; white-space: normal; width: 45%; word-wrap: break-word;;model-body-choose-2 " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) == 2 ? 'model-body-choose-2-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <text  class='model-body-choose-text ' style='text-align: center; transition: all .5s; width: 100%;;model-body-choose-text " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) == 2 ? 'model-body-choose-text-2-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[1]) === "object" ? JSON.stringify(this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[1]) : this.data.li[_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_].answer[1]) + "  </text>  </view>  </view> <view  class='model-bottom' style='undefined;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  class='model-bottom2' style='align-items: center; color: rgba(234,129,113); display: flex; justify-content: center; margin-top: 4%;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'> " + ((_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1) + "/8  </view>  </view>  </view> " : "") + "<view  class='model-end' style='background-color: rgba(234,129,113); border-radius: 20rpx; box-shadow: 2rpx 2rpx 2rpx rgba(234,129,113); color: white; display: " + ((_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) == 0 || (_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) >= 8 ? 'none' : 'block') + "; left: 210rpx; padding: 20rpx 0rpx; position: absolute; text-align: center; top: 90%; width: 45%; z-index: 999;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "' bindtap='choose_return'> \\u4E0A\\u4E00\\u9898  </view> " + ((_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) <= 6 ? "<view  class='model3' animation='" + (_typeof(this.data.animationData2) === "object" ? JSON.stringify(this.data.animationData2) : this.data.animationData2) + "' style='background-color: white; border-radius: 50rpx; height: 700rpx; left: 20%; margin: 0rpx auto; position: absolute; top: 32vh; width: 70%; z-index: 55;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  class='model-top' style='align-items: center; background-color: rgba(234,129,113); border-radius: 50rpx 50rpx 0rpx 0rpx; color: white; display: flex; font-size: 32rpx; justify-content: center; padding: 30rpx 0rpx;;" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].question) === "object" ? JSON.stringify(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].question) : this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].question) + "  </view> <view  class='model-body' style='display: flex; height: 47%; justify-content: center; margin-left: 20rpx; margin-right: 20rpx; margin-top: 22%;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  bindtouchstart='touchstartX' class='model-body-choose-1 ' bindtap='choose_ans' id='1' style='align-items: center; background-color: #b9cfeb; border-radius: 40rpx; box-sizing: border-box; color: white; display: flex; font-size: 40rpx; height: 100%; justify-content: center; margin: 0rpx 20rpx; padding: 10rpx; transition: all .5s; white-space: normal; width: 45%; word-wrap: break-word;;model-body-choose-1 " + ((_typeof(this.data.click) === "object" ? JSON.stringify(this.data.click) : this.data.click) == 1 ? 'model-body-choose-1-true' : '') + ";" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <text  class='model-body-choose-text' style='text-align: center; transition: all .5s; width: 100%;;" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[0]) === "object" ? JSON.stringify(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[0]) : this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[0]) + "  </text>  </view> <view  bindtouchstart='touchstartX' class='model-body-choose-2' bindtap='choose_ans' id='2' style='align-items: center; background-color: #b9cfeb; border-radius: 40rpx; box-sizing: border-box; color: white; display: flex; font-size: 40rpx; height: 100%; justify-content: center; margin: 0rpx 20rpx; padding: 10rpx; transition: all .5s; white-space: normal; width: 45%; word-wrap: break-word;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <text  class='model-body-choose-text' style='text-align: center; transition: all .5s; width: 100%;;" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;  ' : '') + "'> " + (_typeof(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[1]) === "object" ? JSON.stringify(this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[1]) : this.data.li[(_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1].answer[1]) + "  </text>  </view>  </view> <view  class='model-bottom' style='undefined;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <view  class='model-bottom2' style='align-items: center; color: rgba(234,129,113); display: flex; justify-content: center; margin-top: 4%;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'> " + ((_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) + 1) + "/8  </view>  </view>  </view> " : (_typeof(this.data.id_) === "object" ? JSON.stringify(this.data.id_) : this.data.id_) >= 8 ? "<view  class='model2' style='background-color: #74b9ff; border-radius: 50rpx; margin: 0rpx auto; padding-bottom: 30rpx; position: relative; top: 20vh; width: 72%;;" + (this.data.dark === 'dark' ? '    filter: invert(100%) !important;  ' : '') + "'>  <canvas  type='2d' class='model2_canvas' id='shareCanvas' style='background-color: #74b9ff; border-radius: 50rpx; height: 800rpx; width: 100%;;" + (this.data.dark === 'dark' ? '    filter: invert(0%) !important;      ' : '') + "'>   </canvas> <!--  class='show'>  <view  class='imgs'>  <image  class='img' src='../images/touxiang.png' mode='widthFix'>   </image>  </view> <view  class='show_title'>         \\u60A8\\u7684mbti\\u7C7B\\u578B\\u4E3A         <text  class='show_title_text'> " + (_typeof(this.data.MbtiType) === "object" ? JSON.stringify(this.data.MbtiType) : this.data.MbtiType) + "  </text>  </view> <view  class='show_body'>  <text  space='ensp'> " + (_typeof(this.data.describe) === "object" ? JSON.stringify(this.data.describe) : this.data.describe) + "  </text>  </view>  </!--> <view  class='share' bindtap='share' style='background-color: #fff; border-radius: 30rpx; color: rgba(234,129,113); display: flex; justify-content: center; margin: 0 auto; margin-top: 30rpx; padding: 20rpx 0rpx; width: 70%;'> \\u4FDD\\u5B58\\u56FE\\u7247  </view> <view  class='share' bindtap='return' style='background-color: #fff; border-radius: 30rpx; color: rgba(234,129,113); display: flex; justify-content: center; margin: 0 auto; margin-top: 30rpx; padding: 20rpx 0rpx; width: 70%;'> \\u8FD4\\u56DE\\u9996\\u9875  </view>  </view> " : "") + " </view> ";
    ...
    choose_ans: function choose_ans(e) {
      ...
      if (count == res.length) {
        ...
        var use_Time = end - this.data.start;
        console.log(use_Time);
        this.setdata({ use_Time: use_Time });
        this.process(res);
      }
    },
    ...
    initcanvas: function initcanvas(MbtiType, describe) {
      ...
      query.select('#shareCanvas').fields({ node: true, size: true }).exec(function (res) {
        ...
        //背景色块
        _this.draw(ctx, canvas, wpx, dpr, MbtiType, describe);
      });
    },
    ...
    drawiconurl: function drawiconurl(ctx, canvas, wpx) {
      ...
      headerImg.onload = function () {
        ...
        ctx.fillRect(0 * wpx, 0 * wpx, _this2.data.canvas.width * wpx, _this2.data.canvas.height * wpx);
    ...
    onLoad: function onLoad(options) {
      ...
      options = this.options;this.data.dark = wx.getSystemInfoSync().theme;wx.onThemeChange(function (e) {
        console.log(e.theme);_this3.setdata({ dark: e.theme });
      });this.setdata();
    ...
    process: function process(res) {
      ...
      all_type.forEach(function (e) {
        ...
        if (list_type.join("") === t.join("")) {
          _this4.setdata({ MbtiType: e.type, describe: e.des });
          _this4.initcanvas(e.type, e.des);
          return -1;
        }
      });
      //存数据库
      var username = wx.getStorageSync('args').username;
      var School = wx.getStorageSync('args').school;
